...
const UserReviewForm = () => {
  ...
  return (
    <div className="container-fluid bg-dark" style={{ width: '100%', height: '100vh', padding: '5rem' }}>
      ...
      <form onSubmit={handleSubmit} className="text-white">
        ...
        <Button className='btn btn-secondary border-rounded my-2' onClick={()=>{ Navigate('/userprofile')}}>
        Back
      </Button>
      </form>
    </div>
